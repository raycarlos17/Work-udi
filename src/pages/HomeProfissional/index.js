    ...
    if (worker !== false) {
      return (
        <div className="div-dados-worker">
          ...
          <p>
            <PersonIcon className="icon-perfil-profissional" />
            <strong>Name professional: </strong>
            {worker.name}
          </p>
          <hr />
          <p>
            <EmailIcon className="icon-perfil-profissional" />
            <strong>Email professional: </strong>
            {worker.email}
          </p>
          <hr />
          <p>
            <BuildIcon className="icon-perfil-profissional" />
            <strong>Occupation: </strong>
            {worker.occupation}
          </p>
          <hr />
          <p>
            <PhoneIcon className="icon-perfil-profissional" />
            <strong>Contact: </strong>
            {worker.contact}
          </p>
          <hr />
          <p>
            <DescriptionIcon className="icon-perfil-profissional" />
  ...
  return (
    <div>
      ...
      <div className="div-inf-profissional-principal">
        ...
        <hr />
        <p>
          <RecentActorsIcon className="icon-perfil-profissional" />
          <strong>CPF: </strong>
          {user.cpf}
        </p>
        <hr />
        <p>
          <PeopleIcon className="icon-perfil-profissional" />
      ...
      <div className="buttons-profissional">
        {/* <div className='button-alterar-dados-profissional'>
                    <button><Link to={`/alterar/perfil/${id}`} className='link-button-altera-perfil' disabled>CHANGE PROFILE</Link></button>
                </div> */}
        <div className="button-adiciona-dados-profissional">
          <button>
            <Link
              to={`/register/perfil/profissional/${id}`}
              className="link-button-adiciona-perfil-prof"
            >
              PROFESSIONAL DATA
            </Link>
          </button>
